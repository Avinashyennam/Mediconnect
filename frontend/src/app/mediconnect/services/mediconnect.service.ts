...
export class MediConnectService {
  ...
  updateAppointment(appointment: Appointment): Observable<Appointment | null> {
    return this.http.put<Appointment | null>(`${this.baseUrl}/appointment/${appointment.appointmentId}`, appointment);
  }
  ...
  getAppointmentsByPatient(patientId: number): Observable<Appointment[]> {
    console.log("appoitnents with patientId:", patientId);
